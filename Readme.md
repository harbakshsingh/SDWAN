...
Install aide-python-agent:

    (venv) % pip install --upgrade git+https://wwwin-github.cisco.com/AIDE/aide-python-agent.git

Install Sastre-Pro:

    (venv) % pip install --upgrade git+https://wwwin-github.cisco.com/AIDE/Sastre-Pro.git
    
Verify that Sastre-Pro can run:
...
Install aide-python-agent:
    ...
    % python3 -m pip install --upgrade git+https://wwwin-github.cisco.com/AIDE/aide-python-agent.git

Install Sastre-Pro:

    % python3 -m pip install --upgrade git+https://wwwin-github.cisco.com/AIDE/Sastre-Pro.git
...
Clone from the GitHub repository:
    ...
    % git clone https://wwwin-github.cisco.com/AIDE/Sastre-Pro.git
...
Start the docker container:
    ...
    Sastre-Pro Version 1.11. Catalog: 63 configuration items, 12 realtime items.
